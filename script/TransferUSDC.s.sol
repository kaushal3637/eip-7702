...
contract TransferUSDC is Script {
    function run() external {
        ...
        uint256 transferAmount = vm.envOr("TRANSFER_AMOUNT", uint256(100 * 1e6)); // Default: 100 USDC
        ...
        require(walletBalance >= transferAmount, "Insufficient USDC balance in wallet");
        ...
        if (newRecipientBalance == recipientBalance + transferAmount) {
            ...
            console.log("  Wallet balance decreased by:", walletBalance - newWalletBalance);
            console.log("  Recipient balance increased by:", newRecipientBalance - recipientBalance);
        } else {
